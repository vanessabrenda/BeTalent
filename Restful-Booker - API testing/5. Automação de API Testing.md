...
#### Os erros gerados no resultado são bugs da API já evidênciados nos documentos: [Resultado dos testes](https://github.com/vanessabrenda/BeTalent/blob/main/Restful-Booker%20-%20API%20testing/2.%20Resultado%20dos%20testes.md)
