...
A reserva é consultada pelo campo 'checkin' e retorna o(s) ID(s) das reservas que possuem a data de checkin informada.
Evidência: 
...
A reserva é consultada pelo campo 'checkout' e retorna o(s) ID(s) das reservas que possuem a data de checkout informada..
Evidência: 
...
## Para consultar os resultados analisados dos cenários, consulte o documento: [Resultado dos testes](https://github.com/vanessabrenda/BeTalent/blob/main/Restful-Booker%20-%20API%20testing/Resultado%20dos%20testes.md).
