...
### Data: 12/05/2026
### A tela home é a tela "All Items"

## Importante para navegar pelo documeto:
  As evidências desse documento estão todas em vídeo e estão na coluna de 'Evidência' como links, recomenda-se sempre usar a opção abrir em uma nova aba com o botão direito do mouse para não sair da página do documento.   
  Obs.: Alguns itens não tem a coluna 'Evidência', nesse caso o vídeo estará logo abaixo do cenário em seguida de uma legenda como essa: **"Evidências...:"**.
## Cenários Críticos
...
| **Caso de teste** | **Usuário** | **Resultado esperado** | **Resultado obtido**| **Evidência**|
|------------|--------------|----------------|-----------|-----------|
| CT03.1 | standard_user | Botão de 'Checkout' bloqueado se o carrinho estiver vazio. | Botão de checkout está disponível mesmo com o carrinho vazio, fluxo de compra permitido. | Todas as evidências foram realizadas no [CT03](https://github.com/user-attachments/assets/020f0f79-a93b-4535-b1f4-70f35a4b800b). |
...
| CT01.3 | performance_glitch_user  | Logout realizado, apresenta tela de login. | Logout realizado, apresenta tela de login. | [CT01.3](https://github.com/user-attachments/assets/aa56321f-02a2-41c7-ad6a-cb214294ea97) |
...
| **Caso de teste** | **Usuário** | **Resultado esperado** | **Resultado obtido** | **Evidência** |
|------------|--------------|----------------|-----------|-----------|
| CT01.1 | standard_user | As telas do sistema são carregadas em menos de 3 segundos. | As telas do sistema foram carregadas instantaneamente. | As evidências dos outros cenários mostram o baixo tempo de carregamento para esse usuário. |
| CT01.2 | problem_user | As telas do sistema são carregadas em menos de 3 segundos. | As telas do sistema foram carregadas instantaneamente.|  As evidências dos outros cenários mostram o baixo tempo de carregamento para esse usuário. |
...
| CT01.4 | error_user | As telas do sistema são carregadas em menos de 3 segundos. | As telas do sistema foram carregadas instantaneamente. |  As evidências dos outros cenários mostram o baixo tempo de carregamento para esse usuário. |
| CT01.5 | visual_user | As telas do sistema são carregadas em menos de 3 segundos. | As telas do sistema foram carregadas instantaneamente. |  As evidências dos outros cenários mostram o baixo tempo de carregamento para esse usuário. |
##### Consideração geral do cenário 
...
|ID04| O ícone do carrinho deveria ser apresentado como clicável pelo cursor do mouse, conforme padrão do sistema. | Ajustar tipo de clique do carrinho, apresentando o ícone padrão de links. |
|ID05| Na última tela de checkout, onde finaliza a compra, em determinadas combinações de itens, o Preço exibido no Checkout aparece mais caracteres na casa dos centavos: Item total: $113.94999999999999. | Ajustar o sistema para calcular o preço corretamente independente dos itens no carrinho. |
...
|ID08| Visual_user |Os itens apresentam valores incorretos na tela home. | Ajustar a exibição dos preços para o usuário. |
