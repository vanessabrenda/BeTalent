...
| CT02.2 | problem_user | Compra realizada, mensagem de sucesso exibida. | Os itens: Sauce Labs Bolt T-Shirt, Sauce Labs Fleece Jacket e Test.allTheThings() T-Shirt (Red) não foram adicionados ao carrinho, botão 'Add to cart' está sem ação na tela home e no detalhe do item. | [CT02.2](https://github.com/user-attachments/assets/59c3d785-1527-4509-aee5-8679a442c37d) |
...
| CT02.4 | error_user | Compra realizada, mensagem de sucesso exibida. |  Os itens: Sauce Labs Bolt T-Shirt, Sauce Labs Fleece Jacket e Test.allTheThings() T-Shirt (Red) não foram adicionados ao carrinho, botão 'Add to cart' está sem ação na tela home e no detalhe do item. | [CT02.4](https://github.com/user-attachments/assets/e065d915-3d88-4c6f-9f0d-78262e19d4d7) |
...
| CT01.2 | problem_user | Item removido com sucesso. | Os itens: Sauce Labs Backpack, Sauce Labs Bike Light e Sauce Labs Onesie não foram removidos do carrinho, botão 'Remove' está sem ação na tela home, mas o 'Remove' da tela do carrinho funcionou, possibilitando a remoção apenas no carrinho. | [CT01.2](https://github.com/user-attachments/assets/ba876995-2b6b-467a-b5ff-42c306ba9697) |
...
| CT01.4 | error_user | Item removido com sucesso. |  Os itens: Sauce Labs Backpack, Sauce Labs Bike Light e Sauce Labs Onesie não foram removidos do carrinho, botão 'Remove' está sem ação na tela home, mas o 'Remove' da tela do carrinho funcionou, possibilitando a remoção apenas no carrinho.| [CT01.4](https://github.com/user-attachments/assets/9c6d5f39-329b-442c-a3f6-591f52df762c) |
...
| CT01.4 | error_user | Detalhe do produto apresentado corretamente. | Nenhuma descrição foi apresentada corretamente nos detalhes. | [CT01.4](https://github.com/user-attachments/assets/ec6e33f2-b62f-4956-92f8-eebdf6d5bc30) |
...
### Para verificar os detalhes sobre os bugs encontrados acessar o documento: [Análise de bugs](https://github.com/vanessabrenda/BeTalent/edit/main/An%C3%A1lise%20de%20bugs.md#an%C3%A1lise-de-bugs)
