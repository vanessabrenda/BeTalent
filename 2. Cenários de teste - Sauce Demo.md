...
|ID05| Na última tela de checkout, onde finaliza a compra, em determinadas combinações de itens, o Preço exibido no Checkout aparece mais caracteres na casa dos centavos: Item total: $113.94999999999999. | Ajustar o sistema para calcular o preço corretamente quando há 5 itens no carrinho. |
